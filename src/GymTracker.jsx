...
const RUTINA_DEFAULT = {
  ...
  MARTES: {
    ...
    color: "#FF6B9D",
    ejercicios: [
      { nombre: "Hip Thrust con barra", series: 4, reps: 8 },
      { nombre: "Sentadilla profunda (back squat)", series: 4, reps: 8 },
      { nombre: "Romanian Deadlift", series: 3, reps: 12 },
      { nombre: "Abducción de cadera (máquina)", series: 3, reps: 15 },
      { nombre: "Gemelos en prensa", series: 3, reps: 15 },
    ],
  },
  MIÉRCOLES: {
    label: "Descanso 🛌",
  ...
  JUEVES: {
    ...
    color: "#FFD93D",
    ejercicios: [
      { nombre: "Press inclinado con mancuernas", series: 3, reps: 12 },
      { nombre: "Remo en máquina", series: 3, reps: 12 },
      { nombre: "Elevaciones laterales", series: 3, reps: 15 },
      { nombre: "Curl de bíceps en polea", series: 3, reps: 12 },
      { nombre: "Extensión de tríceps sobre cabeza", series: 3, reps: 12 },
      { nombre: "Plancha (core)", series: 3, reps: 40 },
      { nombre: "Crunch en polea o suelo", series: 3, reps: 15 },
    ],
  },
  VIERNES: {
    label: "Push 🔵",
    color: "#60A5FA",
    ejercicios: [
      { nombre: "Press de banca plano con barra", series: 4, reps: 8 },
      { nombre: "Press inclinado con mancuernas", series: 3, reps: 12 },
      { nombre: "Press militar con barra", series: 3, reps: 12 },
      { nombre: "Elevaciones laterales", series: 3, reps: 15 },
      { nombre: "Extensión de tríceps en polea (rope)", series: 3, reps: 12 },
      { nombre: "Fondos en banco o paralelas", series: 2, reps: 12 },
    ],
  },
  SÁBADO: {
    label: "Lower B 🍑",
    color: "#C77DFF",
    ejercicios: [
      { nombre: "Bulgarian Split Squat", series: 4, reps: 12 },
      { nombre: "Hip Thrust con banda", series: 3, reps: 12 },
      { nombre: "Prensa inclinada (pie alto)", series: 3, reps: 12 },
      { nombre: "Cable Kickback / patada en polea", series: 3, reps: 15 },
      { nombre: "Curl femoral acostada", series: 3, reps: 12 },
    ],
  },
  DOMINGO: {
    label: "Pull 🟢",
    color: "#34D399",
    ejercicios: [
      { nombre: "Jalón al pecho (agarre ancho)", series: 4, reps: 10 },
      { nombre: "Remo con barra", series: 4, reps: 10 },
      { nombre: "Remo en polea baja (agarre neutro)", series: 3, reps: 12 },
      { nombre: "Pull-over en polea", series: 3, reps: 12 },
      { nombre: "Curl de bíceps con barra", series: 3, reps: 12 },
      { nombre: "Curl martillo con mancuernas", series: 2, reps: 12 },
    ],
  },
};
